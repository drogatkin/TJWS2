...
public interface Registration {
	 ...
	 *         parameter with the given name did not already exist for the
	 *         Servlet
	 ...
	 *         name, or <tt>null</tt> if no initialization parameter with the
	 *         given
	 *         name exists
	 */
	...
	interface Dynamic extends Registration {
		 ...
		 *            by this dynamic Registration supports asynchronous
		 *            operations,
		 *            false otherwise
		 *
