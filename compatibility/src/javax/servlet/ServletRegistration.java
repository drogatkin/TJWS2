...
public interface ServletRegistration extends Registration {
	 ...
	 *
	 * <p>
	 * If permitted, any changes to the returned <code>Collection</code> must
	 * not
	...
	interface Dynamic extends ServletRegistration, Registration.Dynamic {
		 ...
		 *             this ServletRegistration was obtained has already been
		 *             initialized
		 */
		 ...
		 *         the exact target of a <code>security-constraint</code> that
		 *         was
		 *         established via the portable deployment descriptor. This
		 *         method
		 ...
		 *             which this <code>ServletRegistration</code> was obtained
		 *             has
		 ...
		 *
		 * @throws IllegalStateException if the {@link ServletContext} from
		 *             which this ServletRegistration was obtained has already
		 *             been
		 *             initialized
		 */
