...
public @interface ServletSecurity {
	 ...
	 *         defining the protection to be applied to one HTTP protocol
	 *         method. For
	 *         any HTTP method name, there must be at most one corresponding
	 *         element in
	 *         the returned array. If the returned array is of zero length, it
	 *         indicates
