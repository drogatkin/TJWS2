...
public @interface HttpMethodConstraint {
	 ...
	 *         indicating the data protection that must be provided by the
	 *         connection.
	 */
	 ...
	 *         <code>emptyRoleSemantic</code>. If <code>emptyRoleSemantic</code>
	 *         returns
	 *         <tt>DENY</tt>, and <code>rolesAllowed</code> returns a zero
	 *         length array,
	 ...
	 *         contains the names of one or more roles, it indicates that access
	 *         is
	 *         contingent on membership in at least one of the named roles
	 *         (independent
